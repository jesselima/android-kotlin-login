...
class FirebaseUserLiveData : LiveData<FirebaseUser?>() {
    ...
    //  This FireUserLiveData object by hooking it up to equal the value of the
    //  current FirebaseUser. The FirebaseAuth.AuthStateListener callback provides
    //  updates for the current Firebase user logged into the app.
